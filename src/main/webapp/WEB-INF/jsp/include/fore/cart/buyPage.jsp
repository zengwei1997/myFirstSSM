...
<div class="buyPageDiv">
    <form action="forecreateOrder" method="post">
            ...
            <div>
                    <table class="addressTable">
                        <tr>
                            ...
                            <td><textarea name="address" placeholder="建议您如实填写详细收货地址，例如街道名称，门牌号码，楼层和房间信息"></textarea></td>
                        </tr>
                        <tr>
                            <td>邮政编码</td>
        ...
        <div class="productList">
            <div class="productListTip">请确认信息</div>
                ...
                <thead>
                    <tr>
                        <th colspan="2" class="productListTableFirstColumn">
                            ...
                            <a class="wangwanglink" href="#nowhere"><span class="wangwangGif">
                                </span></a>
                        </th>
                        <th>单价</th>
                        <th>数量</th>
                        ...
                        <tr class="orderItemTR">
                            ...
                            <td class="orderItemProductInfo">
                                <a href="foreproduct?pid=${oi.product.id}" class="orderItemProductLink">
                                    ...
                                    <img src="img/site/creditcard.png" title="支持行用卡支付"/>
        ...
        <div class="submitOrderDiv">
            <button type="submit" class="submitOrderButton">提交</button>
        </div>
    </form>
</div>