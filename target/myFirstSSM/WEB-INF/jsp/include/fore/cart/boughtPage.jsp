        ...
        if(deleteOrder){
            ...
            $.post(page,{"oid":deleteOrderid},function(result){
                if("success" == result){
                    ...
                    $("table.orderListItemTable[oid="+ deleteOrderid + "]").attr("delete",true);
                }else {
        ...
        <c:forEach items="${os}" var="o">
            <table class="orderListItemTable" orderStatus="${o.status}" oid="${o.id}">
                <tr class="orderListItemFirstTR">
                    ...
                    <td colspan="2">
                        <img width="13px" src="img/site/orderItemTmall.png">天猫商城</td>
                    </td>
                    <td colspan="1">
                    ...
                    <tr class="orderItemProductInfoPartTR">
                        ...
                        <td class="orderItemProductInfoPartTD">
                            <div class="orderListItemProductLinkOutDiv">
                                ...
                                <div class="orderListItemProductLinkInnerDiv">
                                        ...
                                        <img src="img/site/7day.png" title="消费者保障服务，承诺7天到货"/>
                        ...
                        <c:if test="${st.count==1}">
                            ...
                            <td valign="middle" rowspan="${fn:length(o.orderItems)}"
                                ...
                                <div class="orderListItemProductRealPrice">￥<fmt:formatNumber  minFractionDigits="2" type="number" value="${o.total}" /></div>
                            ...
                            <td valign="middle" rowspan="${fn:length(o.orderItems)}"
                                ...
                                <c:if test="${o.status=='waitDelivery'}">
                                    ...
                                    <button class="btn btn-info btn-sm ask2delivery"
                                            link="admin_order_delivery?id=${o.id}">
                                        催卖家发货
                                    </button>
                                </c:if>
